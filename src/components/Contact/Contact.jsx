...
export default function Contact({ setActiveSession }) {
  ...
  const sendEmail = (e) => {
    ...
    const serviceID = "service_s15wpxd"; // Your EmailJS Service ID
    const templateID = "template_i3jw4al"; // Your EmailJS Template ID
    const userID = "5yp4fhokNH0eJmnfX"; // Your EmailJS Public Key
      ...
      <div className="h-auto lg:h-[90vh] bg-black flex items-center justify-center p-2 lg:overflow-hidden overflow-y-auto">
        <div className="w-full mx-5 mt-5 flex flex-col lg:flex-row gap-6 lg:gap-10 items-center lg:items-stretch">
          ...
          <div className="w-full max-w-4xl h-[60vh] lg:h-[80vh] rounded-xl overflow-hidden border-2 border-gray-700 bg-gray-900">
            <iframe
              title="My University Location"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d236.15580118106757!2d73.43091409318437!3d18.731511593528055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be8018f99779941%3A0x6d8398f7fcc9db6f!2sSIT%20Sinhgad%20Institute%20Of%20Technology%20Lonavala!5e0!3m2!1sen!2sin!4v1740902282177!5m2!1sen!2sin"
