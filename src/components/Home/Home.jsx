...
import NamrataProfileImage from "../../assets/namrata_biradar_profile.png";
  ...
  return (
    <LampContainer>
      <div className="flex flex-col md:flex-row items-center justify-center min-h-[90vh] w-full px-0 py-8 md:py-16">
        ...
        {/* Uncomment below to view imaes: Image Section - Top on mobile, Left on desktop */}
        ...
        >
          <div className="relative w-full aspect-square rounded-full overflow-hidden hover:scale-105 transition-transform duration-300 mb-20">
            <img
              src={NamrataProfileImage}
              alt="Namrata Professional Portrait"
