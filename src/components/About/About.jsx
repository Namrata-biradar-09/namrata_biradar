...
import resume from "../../assets/resume_namrata.pdf"; // Import your resume PDF
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
              <div className="md:col-span-2 space-y-6">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  ...
                  development and cloud architecture. Currently pursuing BE at Sinhgad institute of technology.
                </p>
                <div className="flex items-center space-x-4">
                  ...
                  <a
                    href={resume}
                    download="Resume-Namrata-Biradar.pdf"
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4 hover:scale-[1.02] transition-transform duration-300">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:namratabiradar09@gmail.com"
                        className="text-white hover:text-blue-400 transition-colors"
                      >
                        namratabiradar09@gmail.com
                      </a>
                    </div>
                  </div>
                  ...
                  {[
                    {
                      icon: faGithub,
                      color: "#181717",
                      url: "https://github.com/Namrata-biradar-09",
                      label: "GitHub",
                    },
                    {
                      icon: faLinkedin,
                      color: "#0A66C2",
                      url: "https://www.linkedin.com/in/namrata-biradar-2202b0256",
                      label: "LinkedIn",
                    },
                    {
                      icon: faInstagram,
                      color: "#E4405F",
                      url: "https://www.instagram.com/biradar_namrataa/",
                      label: "Instagram",
                    },
                    {
                      icon: faYoutube,
                      color: "#FF0000",
                      url: "https://www.youtube.com/@NB-qg5wf",
                      label: "YouTube",
                    },
                    {
                      icon: faTelegram,
                      color: "#1877F2",
                      url: "https://t.me/contact/1740894900:yoc2HA2CDP70hAU8",
                      label: "Telegram",
                    },
                  ].map((social, index) => (
                    <a
